...
class AppStateModel extends foundation.ChangeNotifier {
  ...
  double get subtotalCost {
    return _productsInCart.keys.map((id) {
      ...
      final itemCount = _productsInCart[id] ?? 0;
      return getProductById(id).price * itemCount;
  ...
  void removeItemFromCart(int productId) {
    if (_productsInCart.containsKey(productId)) {
      if (_productsInCart[productId] == 1) {
        ...
        final int? itemCount = _productsInCart[productId];
        if (itemCount != null) _productsInCart[productId] = itemCount - 1;
      }
    }
